...
SWEP.Author = "Grampa Sexy Ted Stevens"
...
function SWEP:PrimaryAttack()	
	...
	if (Trace.Entity.IsFurniture) then self.Weapon:SetNextPrimaryFire(CurTime() + 1); Notify( self.Owner, 1, 4, "You cannot blowtorch furniture!" ); return false end
	
	if( Trace.Entity:GetModel() == "models/weapons/w_c4_planted.mdl" && Trace.Entity.BombTimer != nil )then
		self.Weapon:SetNextPrimaryFire(CurTime() + 1);
		DarkRP.notify( self.Owner, 1, 4, "You cannot blowtorch bombs!" );
		return false;
	end
